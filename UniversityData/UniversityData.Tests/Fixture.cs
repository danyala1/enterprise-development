...
[
    ...
    new Department { Name = "ГИиБ", SupervisorNumber = "890918734" },
    new Department { Name = "Кафедры алгебры и геометрии", SupervisorNumber = "890918735" },
    new Department { Name = "Кафедра высшей математики", SupervisorNumber = "890918736" },
    new Department { Name = "Кафедра информационных технологий", SupervisorNumber = "890918737" }
];
...
[ 
    new Faculty { Name = "Институт информатики и кибернетики", WorkersCount = 16, StudentsCount = 110 },
    new Faculty { Name = "Институт экономики и управления", WorkersCount = 22, StudentsCount = 81 },
    new Faculty { Name = "Юридический институт", WorkersCount = 11, StudentsCount = 65 },
    new Faculty { Name = "Социально-гумманитарный институт", WorkersCount = 30, StudentsCount = 200 },
    new Faculty { Name = "Институт доп. образования", WorkersCount = 22, StudentsCount = 62 },
    new Faculty { Name = "Институт двигателей и энергетических установок", WorkersCount = 16, StudentsCount = 70 }
];
