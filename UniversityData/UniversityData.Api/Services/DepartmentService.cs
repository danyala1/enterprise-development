...
{
    /// <summary>
    /// Сервис для управления департаментами университета.
    /// </summary>
    public class DepartmentService : IEntityService<Department>
    {
        ...
        {
            return _context.Departments.Include(d => d.Specialties).ToList(); 
        }
        ...
        {
            return _context.Departments.Include(d => d.Specialties).FirstOrDefault(d => d.Id == id); 
        }
